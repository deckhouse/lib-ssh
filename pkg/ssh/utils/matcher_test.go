...
func TestMatchSeveralBuffers(t *testing.T) {
...
func TestMatchSeveralBuffersNoRN(t *testing.T) {
	m := NewByteSequenceMatcher("SUCCESS").WaitNonMatched()
...
func TestMatchSeveralBuffersAlmostMatch(t *testing.T) {
	m := NewByteSequenceMatcher("SUCCESS").WaitNonMatched()
...
func TestMatchOneBuffer(t *testing.T) {
	m := NewByteSequenceMatcher("SUCCESS").WaitNonMatched()
...
func TestMatchNoWait(t *testing.T) {
