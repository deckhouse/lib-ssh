...
import (
	...
	sshtesting "github.com/deckhouse/lib-connection/pkg/ssh/testssh"
)
...
func TestCommandOutput(t *testing.T) {
	...
	cmd := NewCommand(sshtesting.CreateSettings(), "cat", testFilePath)
...
func TestCommandPipe(t *testing.T) {
	...
	cmd := NewCommand(sshtesting.CreateSettings(), "bash", "-c", `echo "Goodbye world" | sed "s/Goodbye/Hello/g"`)
